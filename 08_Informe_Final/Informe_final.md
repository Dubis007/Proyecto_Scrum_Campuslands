...
- **Videos y demostración:** [Carpeta de evidencias](https://drive.google.com/drive/u/1/folders/1c-dbEQzobV8-gM08pLgER85Y6HMWYCjn).
...
- [`Daily_Scrum_1.pdf`](../03_Daily_Scrum/Daily_Scrum_1.pdf): evidencia de las reuniones Daily Scrum.
...
La estructura completa de entregables se encuentra en la raíz del repositorio. El archivo [`README.md`](../README.md) está vacío y la carpeta [`10_Videos/`](../10_Videos/) no contiene archivos; por tanto, las evidencias audiovisuales se referencian mediante los enlaces externos de la sección 1.
